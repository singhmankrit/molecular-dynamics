...
| equilibrium_stable_check | `3` | Number of equilibrium checks after which we stop rescaling |
...
| outputs | `["energies", "distances", "animation","pair_correlation","MSD","compressibility"]` | The outputs the simulator should create from the simulation results.
