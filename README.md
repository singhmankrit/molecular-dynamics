...
| ------ | ------- | ----------- |
| particles | `108` | The amount of particles to simulate |
...
| equilibrium_steps | `25` | Number of steps after which rescaling is applied |
| temperature | `1` | The dimensionless temperature of the system |
| temperature_tolerance | `0.2` | Tolerance level for the real vs. target temperature |
| equilibrium_stable_check | `2` | Number of equilibrium checks after which we stop rescaling |
